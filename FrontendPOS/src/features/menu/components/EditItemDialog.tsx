...
export const EditItemDialog = forwardRef<
  HTMLDialogElement,
  EditItemDialogProps
>(({ onClose, onSubmit, initialData }, ref) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const formData = {
      ...
      imagePreview: imageForm.imagePreview,
    };
    onSubmit(formData);
    resetForm();
    onClose();
  ...
  return (
    ...
    >
      <header className="flex justify-between items-center pb-8">
        <span className="font-semibold text-xl text-[#fac604]">Edit Item</span>
        <button
          onClick={handleClose}
