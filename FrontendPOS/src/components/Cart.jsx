...
const CartGrid = () => {
  ...
  const cashChange =
    paymentMethod === 'cash' && cashReceived
      ? Math.max(0, parseFloat(cashReceived) - cartPriceTotal)
      : 0;
  ...
  const handlePayment = () => {
    ...
    const order = createOrder(cart, cartSubTotal, cartPriceTotal);
  ...
  return (
    <>
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <Divider
          sx={{ borderBottomWidth: '0.2rem', borderColor: 'grey.700' }}
        />
        ...
        <Box sx={{ flex: 1, px: '2.5rem', py: '1rem', overflow: 'auto' }}>
          {cart.length === 0 ? (
            ...
            >
              <ShoppingCartIcon
                sx={{ fontSize: '5rem', color: 'text.disabled', mb: '1rem' }}
              />
            ...
            >
              {cart.map((item, index) => (
                ...
                >
                  <Box sx={{ justifyContent: 'center', px: '0.5rem' }}>
        ...
        {cart.length > 0 && (
          <>
            <Divider
              sx={{ borderBottomWidth: '0.2rem', borderColor: 'grey.500' }}
            />
            <Box
              sx={{
                display: 'flex',
            ...
            >
              ...
              <Box>
                ...
                >
                  ...
                  >
                    <AccountBalanceWallet sx={{ fontSize: '1.75rem' }} />
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: 'bold', fontSize: 'medium' }}
                    >
                ...
                <Button
                  ...
                  disabled={
                    paymentMethod === 'cash' &&
                    (!cashReceived || parseFloat(cashReceived) < cartPriceTotal)
                  }
                  sx={{
                    borderRadius: '1rem',
                    fontSize: '1rem',
